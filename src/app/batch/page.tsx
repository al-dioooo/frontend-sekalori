      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-12 px-5 py-16 sm:px-8 lg:flex-row lg:gap-16 lg:px-16 lg:py-20">
          <div className="flex flex-1 flex-col items-start gap-6">
            <Badge className="bg-[#0f5238]/10 font-body text-sm tracking-[0.05em] text-[#0f5238]">
              <span
                aria-hidden="true"
            ...
            <h1 className="font-sans text-5xl font-bold leading-tight tracking-normal text-[#1a1c1a] sm:text-6xl">
              Fiber Boost Week
            </h1>
            <p className="max-w-xl font-body text-lg leading-7 text-[#404943]">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <span className="inline-flex items-center gap-2 rounded-xl border border-[#bfc9bd]/30 bg-[#eeeeea] px-5 py-3 font-body text-sm font-semibold leading-5 tracking-[0.05em] text-[#1a1c1a]">
                <span aria-hidden="true" className="size-2 rounded-full bg-[#1a6b3a]" />
                5 Days
              </span>
              <span className="inline-flex items-center gap-2 rounded-xl border border-[#bfc9bd]/30 bg-[#eeeeea] px-5 py-3 font-body text-sm font-semibold leading-5 tracking-[0.05em] text-[#1a1c1a]">
                <span aria-hidden="true" className="size-2 rotate-45 bg-[#895100]" />
                ~1800 kkal/hari
              </span>
            </div>
          </div>

          <div className="relative flex h-[360px] w-full flex-1 items-center sm:h-[550px] lg:w-auto">
            <div className="absolute inset-[16px_-16px_-16px_16px] rounded-[50%_12%_56%_22%] bg-[#b1f0ce]/30" />
            <div className="relative h-full w-full overflow-hidden rounded-3xl border border-[#e2e3df] bg-white shadow-[0_10px_30px_-10px_rgba(45,106,79,0.12)]">
              <Image
