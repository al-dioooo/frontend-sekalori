    ...
    <MainLayout activeRoute="about">
      <section className="mx-auto flex w-full max-w-7xl flex-col items-center gap-12 px-5 py-16 sm:px-8 lg:flex-row lg:gap-16 lg:px-16 lg:py-20">
        <div className="flex flex-1 flex-col items-start gap-6">
          <Badge className="bg-[#1a6b3a]/10 font-normal text-[#1a6b3a]">
            <span
              aria-hidden="true"
          ...
          <h1 className="max-w-xl font-sans text-5xl font-bold leading-[1.18] tracking-normal text-[#1a6b3a] sm:text-6xl lg:text-[61px]">
            Nourishment Designed by Experts.
          </h1>
          <p className="font-sans text-lg leading-[1.65] text-[#404940]">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <span className="inline-flex items-center gap-3 rounded-full border border-[#bfc9bd] bg-[#fcf9f8] px-5 py-4 font-sans text-base font-semibold text-[#1c1b1b]">
              <span aria-hidden="true" className="h-4 w-3 border-y-2 border-[#1a6b3a]" />
              Daily Meal Plans
            </span>
            <span className="inline-flex items-center gap-3 rounded-full border border-[#bfc9bd] bg-[#fcf9f8] px-5 py-4 font-sans text-base font-semibold text-[#1c1b1b]">
              <span aria-hidden="true" className="size-3 rotate-45 border border-[#1a6b3a]" />
              Event Catering
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-1 justify-center">
          <div className="relative h-[340px] w-full overflow-hidden rounded-[32px] shadow-[0_20px_60px_-30px_rgba(15,82,56,0.45)] sm:h-[408px] sm:rounded-[48px]">
            <Image
