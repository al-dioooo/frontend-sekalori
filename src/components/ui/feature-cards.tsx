...
export function BenefitCard({ icon, title, description }: BenefitCardProps) {
  return (
    <article className="flex min-h-[320px] flex-col items-center justify-center rounded-[32px] border border-[#bfc9bd] bg-[#f6f3f2] p-8 text-center sm:rounded-[48px] lg:p-10">
      <span className="flex size-14 items-center justify-center rounded-full bg-[#1a6b3a] text-white">
...
export function IngredientCard({ icon, title, tone }: IngredientCardProps) {
  return (
    <article className="flex min-h-[202px] flex-col items-center justify-center rounded-2xl border border-[#e2e3df]/70 bg-white p-6 text-center shadow-sm">
      <span
        className={cn(
...
export function PartnerPanel({ partners }: { partners: string[] }) {
  return (
    <section className="rounded-[32px] border border-[#bfc9bd] bg-white px-6 py-12 sm:rounded-[48px] sm:px-12">
      ...
      <div className="mt-10 grid gap-8 opacity-70 sm:grid-cols-2 lg:grid-cols-4">
        {partners.map((partner, index) => (
          ...
          >
            <div className="size-28 rounded-full bg-[#f0eded] sm:size-36" />
